...
FROM '/private/tmp/pls_fy2018_libraries.csv'
WITH (FORMAT CSV, HEADER);

CREATE INDEX libname_2018_idx ON pls_fy2018_libraries (libname);

DROP TABLE IF EXISTS pls_fy2017_libraries;
...
FROM '/private/tmp/pls_fy2017_libraries.csv'
WITH (FORMAT CSV, HEADER);

CREATE INDEX libname_2017_idx ON pls_fy2017_libraries (libname);

DROP TABLE IF EXISTS pls_fy2016_libraries;
...
FROM '/private/tmp/pls_fy2016_libraries.csv'
WITH (FORMAT CSV, HEADER);
